...
def merge_reddit_twitter_balance(reddit_data: str, twitter_data: str, balance_data: str) -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    ...
    merge_all_info_to_jsonl("./final_info.csv", "./transaction_record_simplify.jsonl", "./final_info_transactions.jsonl")